      ...
      <AlertDialog open={open} onOpenChange={setOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will delete <span className="font-medium text-foreground">{category.name}</span>. Products that still reference this category are not updated by the backend.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
